	...
	<body>
		...
		<!-- One -->
			...
			<section id="one" class="wrapper style1 align-center">
				...
				<div class="row">
					<b style="color: white;">Choose Your Product Image</b><br><br>
					<input type="file" name="productPic"></input>
					<br />
				</div>
				<br>
				<div class="row">
					<b style="color: white;">Select Category</b><br>
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  ...
								  <option value="legumes" style="color: black;">Legumes</option>
								  <option value="tuber-crop" style="color: black;">Tuber-Crops</option>
								  <option value="grain" style="color: black;">Grains</option>
								  <option value="poultry" style="color: black;">Poultry</option>
								  <option value="poultry" style="color: black;">Livestock(for Rearing)</option>
								  <option value="poultry" style="color: black;">Livestock( for Meat)</option>
				...
				<br>
				<div class="row">
					<b style="color: white;">Enter Product Name</b><br>
					  <div class="col-sm-6">
				...
				<br>
				<div class="row">
					<b style="color: white;">Enter Product Features</b><br>
				<div class="col-sm-7">
					<textarea  name="pinfo" id="pinfo" rows="2" style="background-color: white; color: black;"></textarea>
				</div>
			</div>
			<br>
			<div class="row">
				<b style="color: white;">Enter Unit Price</b><br>
				<div class="col-sm-6">
			...
			<br>
			<div class="row">
				<b style="color: white;">Enter Quantity</b><br>
				<div class="col-sm-6">
				<input type="number" name="quantity" value="1" min="1" max="" placeholder="Quantity" style="background-color:white;color: black; " required>
				</div>
			</div><br>
			<div class="row">
				<div class="col-sm-6">
					<button class="button fit" style="width:auto; color:black; background-color: blue;">Upload</button>
				</div>
			</div>
		</div>
			</form>

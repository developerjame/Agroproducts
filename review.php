...
<body>
                            ...
                            <center>
                                <div class="row uniform">
                                    <div class="12u 12u$(large)">
                                        <a href="buyNow.php?pid=<?= $pid; ?>,fid=<?= $fid; ?>" class="btn btn-primary" style="text-decoration: none;">Buy Now</a>
                                    </div>
                                </div>
                            </center>
                        </div><br>
			...
			<div class="container">
				...
				<form method="POST" action="reviewInput.php?pid=<?= $pid; ?>">
					<div class="row">
						<b style="color: white;">Review:</b><br>
						<div class="col-sm-7">
							<textarea style="background-color:white;color: black;" cols="5" name="comment" placeholder="Write a review"></textarea>
						</div>
					</div><br>
					<div class="row">
						<b style="color: white;">Rating:</b><br>
						<div class="col-sm-5">
							<input style="background-color:white;color: black;" type="number" min="0" max="10" name="rating" value="0"/>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">

...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Farmer | Manage Customers</h1>
</div>
</div>
...
<a href="viewcustomer1.php?bid=<?php echo $row['bid'];?>, fid=<?php echo $row['fid'];?>">View</a> || <a href="mycustomers.php?id=<?php echo $row['bid']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove">Delete</a>

		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
				<div class="container">
			        ...
			        <form class="form-inline" method="POST" action="productMenu1.php">			       
					       <input style="background-color: white; color: black;" type="text" class="form-control" placeholder="Search here..." name="keyword" required="required" value="<?php echo isset($_POST['keyword']) ? $_POST['keyword'] : '' ?>"/>
				...
				?>
					<h3 style="color: white;">Select Category</h3>
					<form method="GET" action="productMenu1.php?">

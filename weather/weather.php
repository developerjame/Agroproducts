...
<body onload="DefaultScreen()" class="subpage">
    <center>
        <div style="border-bottom: 2px double green;"><h1 style="font-size: 40px; font-weight: bold; color: green;" id="Para1">5 Days Weather Forecast</h1></div>
    ...
    <div style="position: absolute;top: 190%;left: 50%;margin-right: -50%;transform: translate(-50%, -50%);height: 500px;width: 1300px;border: 5px solid rgba(97, 95, 95, 0.829);border-radius: 10px;" id = "weatherContainer">

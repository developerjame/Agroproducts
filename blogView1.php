...
<html>
	...
	<body class="subpage">
		...
		?>
			...
			<div style="position: fixed; width: 120%; margin-top: 630px; background-color: cyan;" class="row uniform">
			...
			<section id="main" class="wrapper">
				<div class="inner">
					...
					<div class="box">
						...
						<form method="post" action="blogView1.php">
							<div class="row">
